...
class test_myCase1(unittest.TestCase):

	@classmethod
	def setUpClass(self):
		d_driver = driver_configure.driver_configure()
		self.driver = d_driver.get_driver()
	...
	def test_something(self):
		...
		self.driver.implicitly_wait(10)
		self.driver.find_element_by_name('买二手房').click()
		self.driver.implicitly_wait(10)
